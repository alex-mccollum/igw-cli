...
MAX_EXECUTE_CALL_CORE_NS="${IGW_PERF_MAX_EXECUTE_CALL_CORE_NS:-1500000}"
MAX_CALL_BATCH_SINGLE_ITEM_NS="${IGW_PERF_MAX_CALL_BATCH_SINGLE_ITEM_NS:-5000000}"
MAX_HANDLE_RPC_CALL_NS="${IGW_PERF_MAX_HANDLE_RPC_CALL_NS:-2500000}"

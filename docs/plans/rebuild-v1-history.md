> Historical execution record, archived when the user approved a workflow-first
> release on 2026-09-05. Its old remaining-work lists and completion requirements
> are superseded by [the current plan](rebuild-v1.md). Original evidence keeps its
> recorded source, parser, and timestamps.

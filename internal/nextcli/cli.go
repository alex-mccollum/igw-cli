// Package nextcli hosts the v1 command tree during the staged rebuild.
package nextcli
...
func (i *invocation) commands() *cobra.Command {
	root := &cobra.Command{Use: "igw-next", Short: "Inspect and operate an Ignition Gateway", SilenceUsage: true, SilenceErrors: true,
	...
	root.AddCommand(i.specCommands(), i.apiCommands(), i.profileCommands(), i.resourceCommands(), i.projectCommands(), i.tagCommands())
	...
	root.AddCommand(&cobra.Command{Use: "schema", Short: "Describe all commands and typed flags without connectivity", Args: cobra.NoArgs,
